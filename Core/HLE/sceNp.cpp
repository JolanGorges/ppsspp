...
int sceNpAuthCreateStartRequest(u32 paramAddr)
{
	...
	INFO_LOG(Log::sceNet, "%s - Service ID: %s", __FUNCTION__, safe_string(Memory::GetCharPointer(params.serviceIdAddr)));
	INFO_LOG(Log::sceNet, "%s - Entitlement ID: %s", __FUNCTION__, safe_string(Memory::GetCharPointer(params.entitlementIdAddr)));
	INFO_LOG(Log::sceNet, "%s - Consumed Count: %d", __FUNCTION__, params.consumedCount);
	INFO_LOG(Log::sceNet, "%s - Cookie (size = %d): %s", __FUNCTION__, params.cookieSize, safe_string(Memory::GetCharPointer(params.cookieAddr)));
...
int sceNpAuthGetEntitlementById(u32 ticketBufferAddr, u32 ticketLength, u32 entitlementIdAddr, u32 arg4)
{
	...
	INFO_LOG(Log::sceNet, "%s - Entitlement ID: %s", __FUNCTION__, safe_string(Memory::GetCharPointer(entitlementIdAddr)));
...
static int sceNpLookupCreateTransactionCtx(u32 lookupTitleCtxIdAddr)
{
	...
	INFO_LOG(Log::sceNet, "%s - Title ID: %s", __FUNCTION__, safe_string(Memory::GetCharPointer(lookupTitleCtxIdAddr)));
